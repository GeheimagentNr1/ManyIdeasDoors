...
public class BigDoorSpruce extends BigDoor {
	...
	public BigDoorSpruce() {
		...
		super( Block.Properties.create( Material.WOOD ).hardnessAndResistance( 3.0F ).sound( SoundType.WOOD ), true,
			registry_name );
	}
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.BIG_DOOR_SPRUCE, properties, registry_name );
	}
}
