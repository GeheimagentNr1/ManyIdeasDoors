...
public class DoorBirchBookshelf extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_BIRCH_BOOKSHELF, properties, registry_name );
	}
}
