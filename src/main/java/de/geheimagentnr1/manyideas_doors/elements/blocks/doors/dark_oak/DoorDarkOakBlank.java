...
public class DoorDarkOakBlank extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_DARK_OAK_BLANK, properties, registry_name );
	}
}
