...
public class DoorIronLaboratory extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_IRON_LABORATORY, properties, registry_name );
	}
}
