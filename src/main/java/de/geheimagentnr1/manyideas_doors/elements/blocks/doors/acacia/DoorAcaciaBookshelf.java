...
public class DoorAcaciaBookshelf extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_ACACIA_BOOKSHELF, properties, registry_name );
	}
}
