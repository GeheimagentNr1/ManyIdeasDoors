...
public class DoorJungleBookshelf extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_JUNGLE_BOOKSHELF, properties, registry_name );
	}
}
