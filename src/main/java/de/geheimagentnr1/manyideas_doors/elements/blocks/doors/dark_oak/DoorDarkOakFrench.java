...
public class DoorDarkOakFrench extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_DARK_OAK_FRENCH, properties, registry_name );
	}
}
