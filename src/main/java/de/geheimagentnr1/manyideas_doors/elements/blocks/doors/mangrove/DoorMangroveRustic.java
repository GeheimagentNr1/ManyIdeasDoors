...
public class DoorMangroveRustic extends DoubleDoorBlock {
	
	
	public static final String registry_name = "door_mangrove_rustic";
	
	public DoorMangroveRustic() {
	...
	public Item getBlockItem( Item.Properties _properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_MANGROVE_RUSTIC, _properties, registry_name );
	}
}
