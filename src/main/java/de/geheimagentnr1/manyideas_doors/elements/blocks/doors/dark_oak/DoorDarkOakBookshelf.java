...
public class DoorDarkOakBookshelf extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_DARK_OAK_BOOKSHELF, properties, registry_name );
	}
}
