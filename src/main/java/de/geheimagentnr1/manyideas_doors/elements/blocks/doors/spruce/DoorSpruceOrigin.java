...
public class DoorSpruceOrigin extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_SPRUCE_ORIGIN, properties, registry_name );
	}
}
