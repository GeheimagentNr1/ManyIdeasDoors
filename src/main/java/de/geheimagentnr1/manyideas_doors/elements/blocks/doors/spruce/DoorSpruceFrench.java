...
public class DoorSpruceFrench extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_SPRUCE_FRENCH, properties, registry_name );
	}
}
