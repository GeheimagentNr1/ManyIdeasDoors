...
public class DoorOakRustic extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_OAK_RUSTIC, properties, registry_name );
	}
}
