...
public class DoorIronShip extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_IRON_SHIP, properties, registry_name );
	}
}
