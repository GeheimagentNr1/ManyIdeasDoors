...
public class DoorBirchFrench extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_BIRCH_FRENCH, properties, registry_name );
	}
}
