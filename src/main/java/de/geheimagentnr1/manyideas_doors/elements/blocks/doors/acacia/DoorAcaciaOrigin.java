...
public class DoorAcaciaOrigin extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_ACACIA_ORIGIN, properties, registry_name );
	}
}
