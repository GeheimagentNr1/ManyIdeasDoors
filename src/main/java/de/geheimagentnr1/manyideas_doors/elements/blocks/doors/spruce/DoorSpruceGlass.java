...
public class DoorSpruceGlass extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_SPRUCE_GLASS, properties, registry_name );
	}
}
