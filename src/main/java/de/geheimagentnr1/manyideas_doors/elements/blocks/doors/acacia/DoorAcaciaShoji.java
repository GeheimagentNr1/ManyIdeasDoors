...
public class DoorAcaciaShoji extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_ACACIA_SHOJI, properties, registry_name );
	}
}
