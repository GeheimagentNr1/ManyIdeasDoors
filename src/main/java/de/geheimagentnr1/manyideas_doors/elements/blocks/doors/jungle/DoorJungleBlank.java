...
public class DoorJungleBlank extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_JUNGLE_BLANK, properties, registry_name );
	}
}
