...
public class DoorSpruceHeart extends DoubleDoorBlock implements BlockItemInterface {
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return createBlockItem( ModBlocks.DOOR_SPRUCE_HEART, properties, registry_name );
	}
}
